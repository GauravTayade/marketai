...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="application/views/assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script type="text/javascript" src="application/views/assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script type="text/javascript" src="application/views/assets/js/plugins/forms/styling/switchery.min.js"></script>
	<script type="text/javascript" src="application/views/assets/js/plugins/forms/styling/uniform.min.js"></script>
	<script type="text/javascript" src="application/views/assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script type="text/javascript" src="application/views/assets/js/plugins/ui/moment/moment.min.js"></script>
	<script type="text/javascript" src="application/views/assets/js/plugins/pickers/daterangepicker.js"></script>
	<script type="text/javascript" src="application/views/assets/js/plugins/ui/nicescroll.min.js"></script>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="application/views/assets/images/flags/gb.png" class="position-left" alt="">
						English
						<span class="caret"></span>
					</a>

					<ul class="dropdown-menu">
						<li><a class="deutsch"><img src="application/views/assets/images/flags/de.png" alt=""> Deutsch</a></li>
						<li><a class="ukrainian"><img src="application/views/assets/images/flags/ua.png" alt=""> Українська</a></li>
						<li><a class="english"><img src="application/views/assets/images/flags/gb.png" alt=""> English</a></li>
						<li><a class="espana"><img src="application/views/assets/images/flags/es.png" alt=""> España</a></li>
						<li><a class="russian"><img src="application/views/assets/images/flags/ru.png" alt=""> Русский</a></li>
					</ul>
				</li>
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content width-350">
						...
						<ul class="media-list dropdown-content-body">
							<li class="media">
								<div class="media-left">
									<img src="application/views/assets/images/placeholder.jpg" class="img-circle img-sm" alt="">
							...
							<li class="media">
								<div class="media-left"><img src="application/views/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
									<a href="#" class="media-heading">
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="application/views/assets/images/placeholder.jpg" alt="">
						<span>Victoria</span>
						<i class="caret"></i>
					</a>
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								<a href="#" class="media-left"><img src="application/views/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></a>
								<div class="media-body">

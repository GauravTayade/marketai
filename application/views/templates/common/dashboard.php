	...
	<div class="col-md-12">
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h6 class="panel-title">Select Your Page:</h6>
			</div>
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<div class="form-group">
							<a class="btn bg-teal-400" name="get-fb-page-list" id="get-fb-page-list" href="javascript:void(0)" onclick="getPageList()">Get My Page List</a>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="panel panel-flat">
        ...
        <div class="container-fluid">
            <div class="row" id="partialview-user-page">
                <div class="col-lg-12">
                    <div class="form-group">
                        <select class="select" name="pages" id="fbpage-list-existing">
                        		<option value="0">Please Select A Page</option>
                            <?php foreach ($user_pages as $page) { ?>
                                <option data-page-id="<?php echo  $page->page_id ?>" value="<?php echo $page->fb_page_id ?>">
	...
	<div class="col-lg-4">
		...
		<div class="panel bg-teal-400">
			<div class="panel-body">
				...
				<h3 class="no-margin" id="total-page-followers"></h3>
	...
	<div class="col-lg-4">
		...
		<div class="panel bg-pink-400">
			<div class="panel-body">
				...
				<h3 class="no-margin" id="total-page-posts"></h3>
				Total Page Posts
				<div class="text-muted text-size-small">489 avg</div>
			</div>
		</div>
...
<div class="col-md-12" id="compititorsData">
				...
				<table class="table text-nowrap">
					...
					<tbody>
						...
						<tr>
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/brands/facebook.png" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-left">
						...
						<tr>
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/brands/youtube.png" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-left">
						...
						<tr>
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/brands/spotify.png" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-left">
						...
						<tr>
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/brands/twitter.png" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-left">
						...
						<tr>
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/brands/bing.png" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-left">
						...
						<tr>
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/brands/amazon.png" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-left">
						...
						<tr>
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/brands/dribbble.png" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-left">
				...
				<table class="table text-nowrap">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="media-left media-middle">
									<a href="#"><img src="application/views/assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
								</div>
								<div class="media-body">
						...
						<ul class="media-list content-group">
							<li class="media stack-media-on-mobile">
								<div class="media-left">
									<div class="thumb">
										<a href="#">
											<img src="application/views/assets/images/placeholder.jpg" class="img-responsive img-rounded media-preview" alt="">
			...
			<div class="tab-content">
				<div class="tab-pane active fade in has-padding" id="messages-tue">
					<ul class="media-list">
						<li class="media">
							<div class="media-left">
								<img src="application/views/assets/images/placeholder.jpg" class="img-circle img-xs" alt="">
